...
This is Step 1 of the content production pipeline. Run this first, then follow with `content-kit-brief`, `content-kit-infographic`, and `content-kit-story`.
...
7. Offers to run `content-kit-brief` next
...
├── briefs/                     ← generated briefs saved here (used by content-kit-brief)
...
Drafts are saved as:
```
content-drafts/content-kit-[NNN]-[topic-slug].md
```

Rename the prefix (`content-kit`) in `SKILL.md` to match your series name.
