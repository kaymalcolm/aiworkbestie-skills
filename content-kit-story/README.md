...
This is Step 4 of the content production pipeline. Run after `content-kit-infographic`.
...
| Requirement | Notes |
|-------------|-------|
| Python 3.12 | Same requirement as `content-kit-infographic` |
...
This is more aggressive than the `content-kit-infographic` version because story images sometimes have watermarks that blend with the background color.
...
```
stories/
├── content-kit-003-story-poll.png
├── content-kit-003-story-stat.png
├── content-kit-003-story-countdown.png
├── content-kit-003-story-question.png
└── content-kit-003-story-quote.png
```
...
- The brief file is optional but improves story quality — run `content-kit-brief` first when possible
