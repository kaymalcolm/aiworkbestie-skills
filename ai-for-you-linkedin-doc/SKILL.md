...
**Explicit:**
- `/ai-for-you-linkedin-doc [post number]` — runs generate mode
- `/ai-for-you-linkedin-doc [post number] generate` — generate mode
- `/ai-for-you-linkedin-doc [post number] pdf` — pdf mode
...
cur.execute("""
    ...
    VALUES ('linkedin-doc-slides','ai-for-you',:1,:2,
            'in-progress',:3,:4,:5)
...
- Remind them to run Mode 2 (pdf) when ready: `/ai-for-you-linkedin-doc [POST_NUMBER] pdf`
...
cur.execute("""
    ...
    VALUES ('linkedin-doc-pdf','ai-for-you',:1,:2,
            'ready',:3,:4,:5,:6)""",
