...
## Post-Based Notebook Routing (AI For You)
...
### Post Notebook (Find or Create)

When working on a specific post (e.g., "add this to post 1039"):
...
All subsequent work in the session uses the notebook set in step 2.
