...
**Explicit:**
- `/content-kit-infographic [post number]`  -  generates ALL THREE (cover + mid + download)
- `/content-kit-infographic [post number] cover`  -  generates Substack cover only
- `/content-kit-infographic [post number] mid`  -  generates mid-article square only
- `/content-kit-infographic [post number] download`  -  generates download/share portrait only
- `/content-kit-infographic [post number] threads`  -  generates threads-specific infographic only
...
cur.execute("""
    ...
    VALUES ('infographic-threads','content-kit',:1,:2,
            'draft',:3,:4,:5)
...
cur.execute("""
    INSERT INTO assets (type, pipeline, short_name, description, status,
                        created_date, updated_date, post_id)
    VALUES ('infographic-cover','content-kit',:1,:2,
            'draft',:3,:4,:5)
    RETURNING id INTO :new_id""",
...
cur.execute("""
    INSERT INTO assets (type, pipeline, short_name, description, status,
                        created_date, updated_date, post_id)
    VALUES ('infographic-mid','content-kit',:1,:2,
            'draft',:3,:4,:5)
    RETURNING id INTO :new_id""",
...
cur.execute("""
    INSERT INTO assets (type, pipeline, short_name, description, status,
                        created_date, updated_date, post_id)
    VALUES ('infographic-download','content-kit',:1,:2,
            'draft',:3,:4,:5)
    RETURNING id INTO :new_id""",
