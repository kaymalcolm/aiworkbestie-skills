...
This is Step 3 of the content production pipeline. Run after `content-kit-brief`.
...
|------|-------------|---------|---------|
| Mid-article | Square (1:1) | Image-forward lifestyle/illustrated scene with stat overlay; goes inside the newsletter | `content-kit-[NNN]-infographic-mid.png` |
| Download/Share | Portrait | Full layout with all rows, bottom stat, CTA bar; save-worthy standalone asset | `content-kit-[NNN]-infographic.png` |
...
```
/content-kit-infographic
/content-kit-infographic [NNN]
/content-kit-infographic [NNN] mid
/content-kit-infographic [NNN] download
```
...
```
infographic/
├── content-kit-003-infographic-mid.png
└── content-kit-003-infographic.png
```
