...
Register a completed AI For You draft in the asset database and add it to the post queue. Called automatically by `/content-kit` after files are saved, or run manually if registration was skipped or needs to be re-run.

## When This Skill Activates

**Explicit:** User types `/content-kit-register [post_number]`

**Called by:** `/content-kit` after STEP 5 (file save complete)
...
if existing_row and existing_row[1]:
    ...
    cur.execute("""
        ...
        VALUES ('script','content-kit',:1,:2,'draft',:3,:4,:5)
        RETURNING id INTO :6""",
