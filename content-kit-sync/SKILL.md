...
**Explicit:** User types `/content-kit-sync [post_number]` — e.g. `/content-kit-sync 1039`

Also responds to `/content-kit-refresh [post_number]` (legacy alias).
...
If no asset row: tell user "No script asset found for post {post_number} in the content-kit pipeline." Stop.
