...
This is Step 2 of the content production pipeline. Run after `content-kit`.
...
```
/content-kit-brief
/content-kit-brief [NNN]
/content-kit-brief content-drafts/content-kit-003-my-post.md
```
...
- A completed draft from `content-kit` (Step 1)
...
Briefs are saved as:
```
briefs/content-kit-[NNN]-brief.md
```
