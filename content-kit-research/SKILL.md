...
**Explicit:** User types `/content-kit-research "[topic]"`
...
- "Run `/content-kit [file-path]` when you're ready for the full draft — edit the Helper Content section first if you want to add context or adjust the B-roll direction."
